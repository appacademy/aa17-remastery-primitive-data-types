...
# A perfect square is a positive integer that can be expressed as the product of
# an integer multiplied by itself, i.e., as that integer squared.  For example,
# 25 is a perfect square of 5 as `5 x 5 = 5**2 = 25`.
